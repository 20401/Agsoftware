...
class BloquesV5 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    { 
        ...
        $block_data_head= [
            'title' => 'Descarga de Catalogos - Head',
            'identifier' => 'descarga-de-catalogo-head.0',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__.'/html/descarga-de-catalogo-head.html'),
        ];
